...
function GetCredits($customer_id)
{
    ...
    function get_all_customers_data($params)
    {
      ...
      // $this->db->_reset_select();
        ...
        $this->db->distinct();
        $this->db->select('customer_id, customer_dni, customer_first_name, customer_last_name, plan_description, customer_due_date, customer_remaining_credits, customer_status');

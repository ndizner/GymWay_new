                                           ...
                                           <div class="col-sm-12">
                                               ...
                                               <div class="card">
                                                   <div class="card-header">
                                                     ...
                                                     <span><p><?php echo anchor('auth/create_user', lang('index_create_user_link'))?> | <?php echo anchor('auth/create_group', lang('index_create_group_link'))?>| <?php echo anchor('auth/disabled', lang('deactivate_users'))?></p></span>

<?php
	...
	$click_action_desc = 'W(P(L(O(C(K(E(R(.(C(O(M - Opens a link, when a marker, region or text is clicked. The url is stored in the click value for each marker or region.';

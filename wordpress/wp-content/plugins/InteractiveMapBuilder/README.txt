...
== Changelog ==
= 2.2.1 =
* Fix for the iframe becoming bigger in Chrome

= 2.2 =
* Better compatibility to other themes, mainly Divi
* Problems with text markers removed

= 2.1 =
* The compatibility to other plugins was improved.
* A database field has been changed to a bigger type.

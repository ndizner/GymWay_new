	...
	<?php echo form_open_multipart('Clientes/edit/'.$customers_data['customer_id']); ?>
                                  ...
                                  <label for="customer_dos" class="control-label"><?php echo lang('cli_sex'); ?></label>
                                    <div class="form-radio">
                                          <div class="radio radio-inline">
                                              <label>
                                                  <input type="radio" name="customer_sex"  <?php echo $customers_data['customer_sex']==1 ? 'checked' : ''; ?> value="<?php echo $this->config->item('Masculino') ?>">
                                                  <i class="helper"></i>Masculino
                                              </label>
                                          </div>
                                          <div class="radio radio-inline">
                                              <label>
                                                  <input type="radio" name="customer_sex" <?php echo $customers_data['customer_sex']==2 ? 'checked' : ''; ?> value="<?php echo $this->config->item('Femenino') ?>">
                                                  <i class="helper"></i>Femenino
                                              </label>
                                          </div>
                                          <div class="radio radio-inline">
                                              <label>
                                                  <input type="radio" name="customer_sex" <?php echo $customers_data['customer_sex']==3 ? 'checked' : ''; ?> value="<?php echo $this->config->item('Otros') ?>">

...
<head>
    <title>GymWay</title>
      ...
      <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/style.css');?>">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/gly.css');?>">
      <!-- Select 2 css -->
                                      ...
                                      <ul class="pcoded-submenu">
                                          <li class=" ">
                                              <a href="<?php echo site_url('Reportes/Pagos');?>">
                                                  <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                  <span class="pcoded-mtext">Ventas de Planes</span>
                                                  <span class="pcoded-mcaret"></span>
                                              </a>
                                          </li>
                                          <li class=" ">
                                              <a href="<?php echo site_url('Reportes/Ventas/');?>">
                                                  <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                  <span class="pcoded-mtext">Ventas de Productos</span>
                                                  <span class="pcoded-mcaret"></span>
                                              </a>
                                          </li>
                                          <li class=" ">
                                          ...
                                          <li class=" ">
                                              <a href="<?php echo site_url('Reportes/Totales/');?>">
                                                  <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
